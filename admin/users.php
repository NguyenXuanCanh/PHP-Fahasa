...
if (isset($_GET["addUser"])) {
    ...
    $active = ($_POST["active"]);
    $addSql = "INSERT INTO user (`taikhoan`, `email`, `matkhau`, `permission`, `active`) VALUES ('$name', '$email', '$password', '$permission','$active')";
                            ...
                            <div class="card mb-3">
                                <div class="card-header">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="permission" class="form-control">
                                                                        ...
                                                                        <?php while ($row = mysqli_fetch_assoc($permissionResult)) { ?>
                                                                            <option value=<?= $row["namePermission"] ?>><?= $row["namePermission"] ?></option>
                                                                        <?php } ?>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control modalInput" name="password" type="text" />
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="modal fade custom-modal" tabindex="-1" role="dialog" aria-labelledby="modal_delete_user" aria-hidden="true" id="modal_delete_user">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <form action="users.php?deleteUser" method="post" enctype="multipart/form-data">
                                ...
                                if (isset($_GET["addUser"])) {
                                    if ($resultAdd) {
                                        ...
                                        echo "<h1 class='mt-4 text-center text-danger'>Thêm thất bại <a href='users.php'>Tải lại trang</a></h1>";
                                    }
                                }
                                ?>
                                <?php
