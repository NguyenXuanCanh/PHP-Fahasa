                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="active">
                                    <a class="active" href="forms-color-picker.php">Color Picker</a>
                                </li>
                            </ul>
                        </li>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="alert alert-success" role="alert">
                        ...
                        <p>You can find examples and documentation about Bootstrap color picker here: <a target="_blank" href="https://farbelous.github.io/bootstrap-colorpicker/index.php">Bootstrap color
                                picker</a></p>
                    </div>
