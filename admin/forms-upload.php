                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="active">
                                    <a class="active" href="forms-upload.php">Multiple File Upload</a>
                                </li>
                                <li>
    ...
    <script>
        $(document).on('ready', function() {
            ...
            $("#filer_example1").filer({
                ...
                uploadFile: {
                    url: "assets/plugins/jquery.filer/html/upload.php",
                    data: null,
                    type: 'POST',
                ...
                onRemove: function(itemEl, file, id, listEl, boxEl, newInputEl, inputEl) {
                    var file = file.name;
                    $.post('assets/plugins/jquery.filer/html/remove_file.php', {
                        file: file
                    });
                },
                onEmpty: null,
