                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="active">
                                    <a class="active" href="media-image-magnifier.php">Image Magnifier</a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h3>
                                        <i class="fas fa-search"></i> Example 1
                                    </h3>
                                </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h3>
                                        <i class="fas fa-search"></i> Example 2
                                    </h3>
                                </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h3>
                                        <i class="fas fa-search"></i> Example 3
                                    </h3>
                                </div>
