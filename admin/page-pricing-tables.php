                ...
                <div id="sidebar-menu">
                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul class="list-unstyled">
                                <li class="active">
                                    <a class="active" href="page-pricing-tables.php">Pricing Tables</a>
                                </li>
                                <li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h3>
                                        <i class="fas fa-table"></i> Pricing table example 1
                                    </h3>
                                </div>
                        ...
                        <div class="col-12">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h3>
                                        <i class="fas fa-table"></i> Pricing Table Example 2
                                    </h3>
                                </div>
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-3">
                                            ...
                                            <div class="price-table text-center">
                                                ...
                                                <ul class="list-group">
                                                    ...
                                                    <li class="list-group-item">
                                                        <i class="icon-ok text-success"></i> Unlimited projects
                                                    </li>
                                                    <li class="list-group-item">
                                                        <i class="icon-ok text-success"></i> 27/7 support
                                                    </li>
                                                </ul>
