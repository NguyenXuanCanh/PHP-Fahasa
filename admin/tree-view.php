                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="active">
                                    <a class="active" href="tree-view.php">Tree View</a>
                                </li>
                                <li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h3>
                                        <i class="far fa-folder-open"></i> Simple Tree View
                                    </h3>
                                </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h3>
                                        <i class="far fa-folder-open"></i> Tree View with Checkboxes
                                    </h3>
                                </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h3>
                                        <i class="fa fa-folder-open-o"></i> Tree View with drag & drop
                                    </h3>
                                </div>
