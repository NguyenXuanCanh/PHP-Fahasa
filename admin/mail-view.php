                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul class="list-unstyled">
                                <li>
                                    <a href="blog.php">List blog posts</a>
                                </li>
                                <li>
                        ...
                        <li class="submenu">
                            ...
                            <ul class="list-unstyled">
                                <li>
                                    <a href="mail-all.php">Inbox</a>
                                </li>
                                <li class="active">
                                    <a class="active" href="mail-view.php">Email view</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <div class="col-xl-12">
                            <div class="breadcrumb-holder">
                                ...
                                <ol class="breadcrumb float-right">
                                    ...
                                    <li class="breadcrumb-item"><a href="mail-all.php">Inbox</a></li>
