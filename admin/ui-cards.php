                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="active">
                                    <a class="active" href="ui-cards.php">Cards</a>
                                </li>
                                <li>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                            <div class="card mb-3">
                                <div class="card-header">
                                    ...
                                    Mix and match multiple content types to create the card you need, or throw everything in there. Shown below are image styles, blocks, text styles, and a list group-all wrapped in a fixed-width card. <a target="_blank" href="http://getbootstrap.com/docs/4.3/components/card/#kitchen-sink">(more
                                        info)</a>
                                </div>
