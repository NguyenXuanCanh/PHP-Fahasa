                ...
                <div id="sidebar-menu">
                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul class="list-unstyled">
                                <li class="active">
                                    <a class="active" href="media-fancybox.php">
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <a data-fancybox class="btn btn-danger mb-3" href="https://www.google.lv/maps/place/Googleplex/@37.4220041,-122.0833494,17z/data=!4m5!3m4!1s0x0:0x6c296c66619367e0!8m2!3d37.4219998!4d-122.0840572" role="button">Google Map</a>

                                    <a data-fancybox class="btn btn-danger mb-3" data-caption="Text here" href="https://via.placeholder.com/400x350" role="button">Instagram photo</a>
                                </div>
                            </div><!-- end card-->
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <a data-fancybox="ajax" data-src="assets/plugins/fancybox/ajax.php" data-type="ajax" class="btn btn-danger mb-3" role="button" href="javascript:;">Ajax request</a>
                                    <a data-fancybox="iframe" data-src="assets/plugins/fancybox/iframe.php" data-type="iframe" class="btn btn-danger mb-3" role="button" href="javascript:;">Iframed page</a>
                                </div>
                            </div><!-- end card-->
                        </div>
                    ...
                    <div id="modal" style="display: none; padding: 50px 5vw; max-width: 800px;text-align: center;">
                        ...
                        <p>This is a sample login form, but you may put any HTML here. <br />For example, a link to <a href="https://mozilla.github.io/pdf.js/web/viewer.php" data-fancybox data-type="pdf">PDF file</a>
