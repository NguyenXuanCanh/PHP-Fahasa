<div class="web__content pb-4">
    ...
    <div class="icon__menu container">
        <ul class="row">
            <li class="col-2">
                <a href="#">
                    <img src="./assets/img/ico_flashsale.png" alt="" class="w-50">
                    <p>Flash sale</p>
                </a>
            </li>
            <li class="col-2">
                <a href="#">
                    <img src="./assets/img/ico_PCSC_hot.png" alt="" class="w-50">
                    <p>Phiên Chợ
                        Sách Cũ</p>
                </a>
            </li>
        ...
        <div class="flash__sale__content">
            <a href="product.php">
                <div class="item flash__sale__item">
                    ...
                    <div class="progress"><span class="progress-value">Đã Bán 25</span>
                        <div class="progress-bar" role="progressbar" style="width: 41.66666666666667%;" aria-valuenow="41.66666666666667" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                </div>
            </a>
            <a href="#">
    ...
    <div id="fahasaDeal" class="flash__sale container mt-4">
        <div class="flash__sale__head">
            ...
            <span class="black__title">Fahasa deals</span>
        </div>
        <div class="fahasa__deal row">
            <div class="col-3">
                <a href="#">
                    <div class="item flash__sale__item">
                        <img src="./assets/img/hnplus_1.png" alt="" class="w-100">
