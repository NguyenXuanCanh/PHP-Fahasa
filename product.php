                ...
                <div class="col-5">
                    <div class="row">
                        ...
                        <div class="col-9 img__right pl-0">
                            <img src="./assets/img/image_218832_big.jpg" alt="" class="w-100">
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row mt-3">
                        <div class="col-6">
                            <div class="book__provider">
                                ...
                                <span id="bookProvider">1980 Books</span>
                            </div>
                            <div class="book__publishing__company">
                                <span>Nhà xuất bản: </span>
                                <span id="bookPublisingCompany">NBX Đại Học Kinh Tế Quốc Dân</span>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="book__author">
                                <span>Tác giả: </span>
                                <span id="bookAuthor">săm quan</span>
                            </div>
                            <div class="book__cover">
                                <span>Hình thức bìa: </span>
                                <span id="bookCover">bìa mềm</span>
                            </div>
                        </div>
                    </div>
